...
namespace StarterAssets
{
	...
	public class fpsController : MonoBehaviour
	{
		...
		{
			//_rigidbody.AddForce(Vector3.RotateTowards(Vector3.up, rune.transform.rotation.eulerAngles.normalized, 1.0f, 0.0f) * 100);
			//Debug.Log(Vector3.up * 5);

			//_controller.Move(Vector3.RotateTowards(Vector3.up, rune.transform.rotation.eulerAngles.normalized, 1.0f, 0.0f) * 5);
			//Debug.Log(Vector3.RotateTowards(Vector3.up, rune.transform.rotation.eulerAngles.normalized, 1.0f, 0.0f) * 100);
